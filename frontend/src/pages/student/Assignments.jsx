...
export default function StudentAssignments() {
  ...
  const [selectedBatch, setSelectedBatch] = useState(() => {
    const saved = localStorage.getItem("studentAssignments_selectedBatch");
    return saved || "";
  });

  // Save selected batch to localStorage whenever it changes
  useEffect(() => {
    localStorage.setItem("studentAssignments_selectedBatch", selectedBatch);
  }, [selectedBatch]);
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Submit your work before deadlines</p>
        </div>
        {batches.length > 0 && (
          <select
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>Your instructor hasn't added assignments for this batch</p>
        </div>
      ) : (
                    ...
                    >
                      ...
                      {submitted && (
                        <span className="badge badge-green">
                          <MdCheckCircle size={11} /> Submitted
                        </span>
                      )}
                      {!submitted && late && (
                        <span className="badge badge-red">
                          <MdWarning size={11} /> Overdue
                        </span>
                      )}
                      {!submitted && !late && (
                    ...
                    {!submitted && (
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            handleSubmit(a._id, e.target.files[0])
                          }
                        />
                        <button
